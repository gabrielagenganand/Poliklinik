...
<div class="form-group mx-sm-3 mb-2">
    ...
    <div class="form-group mx-sm-3 mb-2">
        ...
        <input type="datetime-local" class="form-control" name="tgl_periksa" id="inputtglperiksa" placeholder="tgl_periksa" value="<?php echo $tgl_periksa ?>">
    </div>
...
if (isset($_POST['simpan'])) {
    if (isset($_POST['id'])) {
        ...
        $tambah = mysqli_query($mysqli, "INSERT INTO periksa(id,id_dokter,id_pasien,tgl_periksa,catatan) 
                                        VALUES ( 
                                            '" . $_POST['id'] . "',
                                            '" . $_POST['id_dokter'] . "',
                                            '" . $_POST['id_pasien'] . "',
